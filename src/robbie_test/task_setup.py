...
def setup_task_environment(self):
    ...
    rospy.loginfo("Waiting for move_base action server...low_battery_threshold %s " % str(self.low_battery_threshold) )
    ...
    self.waypoints.append(Pose(Point(1.0, 0.0, 0.0), Quaternion(0.000, 0.000, -0.704, 0.710)))
    self.waypoints.append(Pose(Point(1.0, -1.0, 0.0), Quaternion(0.000, 0.000, -0.384, 0.923)))
    self.waypoints.append(Pose(Point(0.0, -1.0, 0.0), Quaternion(0.000, 0.000, -0.851, 0.526)))
    self.waypoints.append(Pose(Point(0.0, 0.0, 0.0), Quaternion(0.000, 0.000, 0.745, 0.667)))
    ...
    self.docking_station_pose = (Pose(Point(0.4, -0.4, 0.0), Quaternion(0.0, 0.0, 0.0, 1.0)))            
